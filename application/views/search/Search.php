        ...
        <div class="petitionContainerSignedText" align="center">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" style="width: 250px; text-align:left; background-color:#f0efef;border: 1px solid #D7D8D9;">
                        <li style="width: 250px;"><a style="color: #346699 !important;"href="<?php echo base_url().'search/index/1/'.$search?>"><i class="icon-chevron-down"></i> Total voturi</a></li>                        
                        <li style="width: 250px;"><a style="color: #346699 !important;"href="<?php echo base_url().'search/index/2/'.$search?>"><i class="icon-chevron-down"></i> Data expirării</a></li>
                </ul>
            </div>
            <div class="btn-group">
