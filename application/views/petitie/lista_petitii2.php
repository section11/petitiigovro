<div id="content-wrapper" class="drop-shadow">
    <div id="content">
        <div class="petitionContainerSignedText" align="center">
            <div class="btn-group">
                <button class="btn dropdown-toggle" style="width: 240px"><b><span style="font-variant: small-caps">Petiții deschise &ndash; <?php echo $categorie2 ?></span></b></button>
            </div>
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" style="width: 250px; text-align:left; background-color:#f0efef;border: 1px solid #D7D8D9;">
                        <li style="width: 250px;"><a style="color: #346699 !important;"href="<?php echo base_url().'petitii_deschise/categorie/'.$categorie.'/1'?>"><i class="icon-chevron-down"></i> Total voturi</a></li>                        
                        <li style="width: 250px;"><a style="color: #346699 !important;"href="<?php echo base_url().'petitii_deschise/categorie/'.$categorie.'/2'?>"><i class="icon-chevron-down"></i> Data expirării</a></li>
                </ul>
            </div>
            <div class="btn-group">
