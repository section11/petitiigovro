...
/////pai are serverul suport de namespace !codeigntier ca ,core nu stie namespace .... de aia cred ca nici nu iti merge .... acolo pe xamp mergea
///ok fa un phpinfo si vezi ce versiune de php ai ca daca ai mai mica de 5.3 nu o sa iti mearga vechi .... 
class PetitiiRaspuns extends CI_Model {
 
	
    private $url = "http://rogovdata.cloudapp.net:8080/v1/RoGovOpenData/RaspunsuriPetitii/"; //the URL we are pointing at
    ...
    public function excuteRequest() { // function that was cute a long time ago
