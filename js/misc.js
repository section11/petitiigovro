...
(@_jscript_version<5.5)) isIEmac=true; @end @*/
    ...
    function hotKeys() {
        ...
        return ((str) ? 'Apăsați ' + str + ' pentru a adăuga această pagină la favorite.' : str);
    }
    ...
    function addBookmark(a) {
        try {
            if (isMSIE && typeof window.external == "object") {
		    if (isIE8()) {
                    ...
                    return false;
                } else if (typeof a == "object" && a.tagName.toLowerCase() == "a") {
